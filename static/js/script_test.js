$(document).ready(function () {
    ...
    function processDataa() {
        ...
        // Create an array of values for each key
        keys.forEach(function (key) {
            processedData[key] = allData.map(function (item) {
                return item[key];
            });
        });
    ...
    $('#train_all_test').click(function () {
        console.log('train_all_test called.......')
        $("#view-result").show();
        updateTable(allData)
